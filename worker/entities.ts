...
import type { User, Chat, ChatMessage, Application } from "@shared/types";
...
// APPLICATION ENTITY: stores onboarding submissions
export class ApplicationEntity extends IndexedEntity<Application> {
  ...
  static readonly initialState: Application = {
    ...
    hasChiefAccountant: false,
    founders: [],
    selectedPackageId: "",
    confirmedConditions: false,
    hasLandCertificate: false,
    status: 'pending',
    submittedAt: 0
  };
}
